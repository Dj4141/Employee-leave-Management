                            ...
                            <div class="card stats-card">
                                <div class="card-content" style="background-color: whitesmoke;">
                                    ...
                                    <span class="stats-counter">
                                        ...
                                        <span class="counter" style="color: pink;"><?php echo htmlentities($empcount); ?></span></span>
                                </div>
                        ...
                        <div class="col s12 m12 l4">
                            <div class="card stats-card">
                                <div class="card-content" style="background-color: whitesmoke;">
                                    ...
                                    ?>
                                    <span class="stats-counter"><span class="counter" style="color: pink;"><?php echo htmlentities($dptcount); ?></span></span>
                                </div>
                                <div class="progress stats-card-progress">
                                    <div class="determinate" style="width: 70%"></div>
                                </div>
                        ...
                        <div class="col s12 m12 l4">
                            <div class="card stats-card">
                                <div class="card-content" style="background-color: whitesmoke;">
                                    ...
                                    ?>
                                    <span class="stats-counter"><span class="counter" style="color: pink;"><?php echo htmlentities($leavtypcount); ?></span></span>
                        ...
                        <div class="col s12 m12 l4">
                            <div class="card stats-card">
                                <div class="card-content" style="background-color: whitesmoke;">
                                    ...
                                    ?>
                                    <span class="stats-counter"><span class="counter" style="color: pink;"><?php echo htmlentities($totalleaves); ?></span></span>
                        ...
                        <div class="col s12 m12 l4">
                            <div class="card stats-card">
                                <div class="card-content" style="background-color: whitesmoke;">
                                    ...
                                    ?>
                                    <span class="stats-counter"><span class="counter" style="color: pink;"><?php echo htmlentities($approvedleaves); ?></span></span>
