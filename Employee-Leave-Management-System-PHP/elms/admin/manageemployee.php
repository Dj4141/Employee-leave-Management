                                            ...
                                            <tr>
                                                ...
                                                <td><a href="editemployee.php?empid=<?php echo htmlentities($result->id); ?>"><i class="material-icons">mode_edit</i></a>
                                                    <?php if ($result->Status == 1) { ?>
                                                        <a onclick="myFun(<?php echo $result->id ?>, 'manageemployee.php?inid=', 'Are you sure you want to inactive this Employe?');"> <i class=" material-icons" title="Inactive">clear</i>
                                                        <?php } else { ?>

                                                            <a onclick="myFun(<?php echo $result->id?>, 'manageemployee.php?id=', 'Are you sure you want to active this employee?');"><i class=" material-icons" title="Active">done</i>
                                                            <?php } ?>
                                                </td>
                                            </tr>
                                    <?php $cnt++;
